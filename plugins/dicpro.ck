...
/网页图测试(.*)
res = $读文件 /storage/emulated/0/美化包/index.html 你好$
a = $html %res% 1080 1080$
$发送 ±img url=%a%±$
...
查询
h={"Authorization":"Bearer sk-4b4Hp4DeClYvGFnj1rT1cLsRJARxk8cJzkaJcXLVADK1QJOv"}
a=$访问 https://newapi.mikumiku.love/v1/models get %h%$
$发送 %a%$
